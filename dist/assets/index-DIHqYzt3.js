        ...
        <main class="sheet">
          ...
          <section class="captain-grid">
            <article class="captain-card">
              ...
              <div class="captain-name">${me(r)}</div>
            </article>
            <article class="captain-card">
              <h2>Team B Captain</h2>
              <div class="captain-name">${me(s)}</div>
            </article>
          </section>
